    ...
    <div className="min-h-screen bg-blue-200 flex items-center justify-center p-6">
      <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-blue-800 mb-2" style={{ fontFamily: 'Bookmania, serif' }}>
...
export default function BarberDashboard() {
  ...
  // Initial data fetch and auto-refresh - MOVED TO TOP AFTER STATE
  useEffect(() => {
  ...
  }, [status]); // Added status as dependency
   ...
   <div className="min-h-screen bg-blue-200 p-6 text-blue-800">
    ...
    <div className="w-full mb-4 flex justify-between items-center">
     ...
     <div className="flex items-center space-x-4">
      ...
      <button
       onClick={() => signOut()}
       className="text-sm bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded-md transition duration-200"
      >
       Sign Out
      </button>
     </div>
